...
@section('title' , "Edit SubCategory ($subcategory->title)")
@section('content')
        ...
        <div class="col-12">
            <div class="card shadow-lg mb-4">
                <div class="card-header">
                    <strong>Edit SubCategory (<span class="text-primary">{{ $subcategory->title }}</span>) </strong>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-dark btn-md px-2 py-2 font-weight-bold fs-6 shadow borderd-2 rounded" href="{{ route('Subcategories.index') }}">Return To Subcategories </a>
